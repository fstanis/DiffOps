  ...
  return (
    ...
    >
      <DiffViewerHeader
        ...
        explainAction={
          <ExplainButton
            disabledReason={explain.disabledReason}
            isBusy={explain.isBusy}
            isActive={explain.isPanelOpen}
            onClick={explain.toggleExplain}
          />
        }
      />
      ...
      {!isCollapsed && (
        <FileLevelTokensProvider value={fileLevelTokens}>
          <div className="overflow-y-auto">
            {file.isBinary && viewer.id !== 'image' ? (
              <div
                className="px-4 py-6 text-center text-xs text-github-text-muted select-none border-t border-github-border"
