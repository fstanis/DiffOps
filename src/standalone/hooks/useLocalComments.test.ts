...
describe('useLocalComments', () => {
  ...
  it('should load comments from localStorage on mount', () => {
    ...
    expect(localStorageMock.getItem).toHaveBeenCalledWith('diffops-comments-test-commit');
  ...
  it('should clear all comments and remove from localStorage', () => {
    ...
    expect(result.current.comments).toEqual([]);
    expect(localStorageMock.removeItem).toHaveBeenCalledWith('diffops-comments-test-commit');
  });
  ...
  it('should save comments to localStorage whenever they change', () => {
    ...
    expect(localStorageMock.setItem).toHaveBeenCalledWith('diffops-comments-test-commit', '[]');
  });
  ...
  it('should use default storage key when no commit hash provided', () => {
    ...
    expect(localStorageMock.setItem).toHaveBeenCalledWith('diffops-comments', expect.any(String));
  });
