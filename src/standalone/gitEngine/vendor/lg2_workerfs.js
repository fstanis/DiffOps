async function Module(moduleArg = {}) {
  ...
  function findWasmBinary() {
    if (Module['locateFile']) {
      return locateFile('lg2_workerfs.wasm');
    }
    return new URL('lg2_workerfs.wasm', import.meta.url).href;
  }
  ...
  var ASM_CONSTS = {
    ...
    106932: ($0, $1, $2) => Module.emscriptenhttpread($0, $1, $2),
    106982: ($0, $1) => {
      const url = UTF8ToString($0);
      return Module.emscriptenhttpconnect(url, $1, 'POST', {
        'Content-Type':
          url.indexOf('git-upload-pack') > 0
            ? 'application/x-git-upload-pack-request'
            : 'application/x-git-receive-pack-request',
      });
    },
    107211: ($0, $1, $2) => Module.emscriptenhttpwrite($0, $1, $2),
  };
  var _malloc,
    _main,
    _htonl,
  ...
  function assignWasmExports(wasmExports) {
    _malloc = wasmExports['$'];
    _main = Module['_main'] = wasmExports['aa'];
    _htonl = wasmExports['ba'];
    _ntohs = wasmExports['ca'];
    _htons = wasmExports['da'];
    _emscripten_builtin_memalign = wasmExports['ea'];
  ...
  var wasmImports = {
    ...
    F: ___syscall_openat,
    C: ___syscall_poll,
    D: ___syscall_poll_nonblocking,
    y: ___syscall_readlinkat,
    p: ___syscall_recvfrom,
    x: ___syscall_renameat,
    h: ___syscall_rmdir,
    o: ___syscall_sendto,
    n: ___syscall_setsockopt,
    g: ___syscall_socket,
    W: ___syscall_stat64,
    v: ___syscall_symlinkat,
          ...
          '(' +
            function requestWorker() {
              ...
              const req = require(workerData.url.indexOf('https') === 0 ? 'https' : 'http').request(
                workerData.url,
                { headers: workerData.headers, method: workerData.method },
                (res) => {
                  res.on('data', (chunk) => {
