...
/**
 * 3-layer check: path/filename patterns, then universal header patterns, then language-specific header patterns.
 * @param parsedPath The decoded git path of the file.
 * @param getHeaderLines Lazily returns the first ~20 lines of the file; layers 2-3 need it, layer 1 doesn't call it.
 */
export function isGeneratedFile(
  ...
  // Skip content checks for markdown files: they're documentation and often contain examples of generated headers, which would false-positive.
